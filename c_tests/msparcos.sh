...
$gccpath/sparc-linux-gcc -x c++ -DNDEBUG -DSPARCOS -DTARGET_BIG_ENDIAN -fno-builtin -I.. -O$optlevel -mcpu=v8 ../sparcos.cxx ../sparc.cxx -o sparcos.elf -l:libstdc++.a -static
